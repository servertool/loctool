...
echo $thanhngang;
  echo $toandz.$luc."Nhập Access_token : $BWhite";
...
echo $thanhngang;
echo $do."[".$luc."●".$do."] ".$trang."=> ".$luc."Nhập ".$do."[".$vang."1".$do."]".$luc." Bật Job Like\n"; 
echo $do."[".$luc."●".$do."] ".$trang."=> ".$luc."Nhập ".$do."[".$vang."2".$do."]".$luc." Bật Job Follow\n"; 
echo $do."[".$luc."●".$do."] ".$trang."=> ".$luc."Nhập ".$do."[".$vang."3".$do."]".$luc." Bật Job Cảm Xúc\n"; 
echo $do."[".$luc."●".$do."] ".$trang."=> ".$luc."Nhập ".$do."[".$vang."4".$do."]".$luc." Bật Job Comment\n"; 
echo $do."[".$luc."●".$do."] ".$trang."=> ".$luc."Nhập ".$do."[".$vang."5".$do."]".$luc." Bật Job Fanpage\n"; 
echo $do."[".$luc."●".$do."] ".$trang."=> ".$luc."Nhập ".$do."[".$vang."6".$do."]".$luc." Bật Job Share\n"; 
echo $do."[".$luc."●".$do."] ".$trang."=> ".$luc."Nhập ".$do."[".$vang."7".$do."]".$luc." Bật Job Cảm Xúc CMT\n"; 
echo $thanhngang;
...
echo $do."[".$luc."●".$do."] ".$trang."=> ".$luc."Sau ".$vang.$xxxxx.$luc." Job Dừng Bao Lâu: $vang"; 
$delaybl = trim(fgets(STDIN));
echo $do."[".$luc."●".$do."] ".$trang."=> ".$luc."Đổi Nick Sau Bao Nhiêu Job: $vang"; 
$doinick = trim(fgets(STDIN)); 
echo $do."[".$luc."●".$do."] ".$trang."=> ".$luc."Bao Nhiêu Job Thì Dừng Tool: $vang"; 
...
if ($cauhinh["data"]["msg"] == "Cấu hình thành công!") {
	echo $thanhngang;
    echo $vang."[Lộc-Tool]$luc - Đang Cấu Hình FB: ".$BYellow.$tenfb."".$res."\n";
    echo $thanhngang;
} 
$spam = 0;
while (true) {
          ...
          array_splice($khocookie,$xz,1);
            ...
            break;
                ...
                if ($nhanlike["success"] == 200) {
                    ...
                    if ( $dem >= $dungtool ){
    echo $thanhngang; echo $toandz.$luc."Đã làm xong \033[1;93m".$dem."\033[1;92m nhiệm vụ, Chạy tiếp không bạn (y/n): \033[1;93m";
    	$stop = trim(fgets(STDIN));
if ( $stop == "n" ){
	$dungtool = 999999;
    echo $toandz.$luc."Bạn Đã Chọn Dừng Tool Số Xu Của Bạn Là : ".$BWhite.$xu."\n";
    echo $toandz.$luc."Cảm Ơn Bạn Đã Sử Dụng Tool Của Lộc Tool\n";
    exit;}
 else {
	echo $toandz.$luc."Bạn Muốn Chạy Thêm Bao Nhiệm Nhiệm Vụ Nữa : $BWhite";
		$chaythem = trim (fgets(STDIN));
 $dungtool = $dungtool + $chaythem;}
 echo $toandz.$luc."Bạn Muốn Chạy Cookie Mới Không (y/n) : $BWhite";
...
if ( $stop == "n" ){
	...
	echo $toandz.$luc."Bạn Muốn Chạy Thêm Bao Nhiệm Nhiệm Vụ Nữa : $BWhite";
		$chaythem = trim (fgets(STDIN));
 $dungtool = $dungtool + $chaythem;}
 echo $toandz.$luc."Bạn Muốn Chạy Cookie Mới Hay Cookie Cũ (y/n) : $BWhite";
 	$themtk = trim (fgets(STDIN));
 if ( $themtk == "y" ){
 $spam = 1;
 $themtk = 1;
